<template>
  <div class="app-container">
    ...
    <el-form label-width="100px" class="form-table">
      ...
      <el-row style="text-align: right; padding-right: 200px">
        <el-button @click="back" autofocus type="primary" size="large">
          返回
        </el-button>
      </el-row>
    </el-form>

    <h2  v-if="borrower.status === '认证中'">借款额度审核</h2>
...
export default {
  ...
  methods: {
    ...
    fetchDataById() {
      borrowerApi
        .getBorrowerDeatilById(this.$route.params.id)
        .then((response) => {
