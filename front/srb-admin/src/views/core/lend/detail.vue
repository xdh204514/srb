  ...
  <div class="app-container">
    ...
    <el-table :data="lendItemList" stripe style="width: 100%" border>
      ...
      <el-table-column
        ...
        align="center"
      />
      <el-table-column prop="investName" label="投资用户" align="center" />
      <el-table-column prop="investAmount" label="投资金额" align="center" />
      <el-table-column label="年化利率" align="center">
        <template slot-scope="scope">
          {{ scope.row.lendYearRate * 100 }}%
        </template>
      </el-table-column>
      <el-table-column prop="investTime" label="投资时间" align="center" />
      <el-table-column prop="lendStartDate" label="开始日期" align="center" />
      <el-table-column prop="lendEndDate" label="结束日期" align="center" />
      <el-table-column prop="expectAmount" label="预期收益" align="center" />
      <el-table-column prop="investTime" label="投资时间" align="center" />
    </el-table>
    ...
    <el-table :data="lendReturnList" stripe style="width: 100%" border>
      <el-table-column type="index" label="序号" width="70" align="center" />
      <el-table-column prop="currentPeriod" label="当前的期数" align="center" />
      <el-table-column prop="principal" label="本金" align="center" />
      <el-table-column prop="interest" label="利息" align="center" />
      <el-table-column prop="total" label="本息" align="center" />
      <el-table-column
        prop="returnDate"
        label="还款日期"
        width="150"
    ...
    <el-row style="text-align: right; margin: 40px">
...
export default {
  ...
  methods: {
    fetchDataById() {
      lendApi.getLendDetail(this.$route.params.id).then((response) => {
